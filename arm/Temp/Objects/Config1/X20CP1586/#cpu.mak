...
export AS_CPU_PATH_2 := D:/ASprojects/arm/Temp//Objects/$(AS_CONFIGURATION)/$(AS_PLC)
...
$(AS_BINARIES_PATH)/$(AS_CONFIGURATION)/$(AS_PLC)/Transfer.lst: \
	FORCE
	@"$(AS_BIN_PATH)/BR.AS.FinalizeBuild.exe" "$(AS_PROJECT_PATH)/arm.apj" -t "$(AS_TEMP_PATH)" -o "$(AS_BINARIES_PATH)" -c "$(AS_CONFIGURATION)" -i "D:/BrAutomation/AS42" -S "X20CP1586"  -all -A "X20CP1586" -pil   -swFiles "$(AS_PROJECT_PATH)/Physical/Config1/X20CP1586/Cpu.sw" -Z "GMC: 3.17.3, mapp: 1.61.0, TextSystem: n.d, Connectivity: n.d, AAS: n.d" -C "/RT=1000 /AM=* /DAIP=127.0.0.1 /REPO=11160 /ANSL=1" -D "/IF=tcpip /LOPO=11159 /SA=1" -M IA32 -T SG4
...
include $(AS_CPU_PATH)/robot/robot.mak
