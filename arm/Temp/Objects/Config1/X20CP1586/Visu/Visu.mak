...
PANEL_HW_SOURCE_Visu=D:/ASprojects/arm/Physical/Config1/Hardware.hw 
DIS_OBJECTS_Visu=$(PANEL_HW_OBJECT_Visu) $(KEYMAP_OBJECTS_Visu)

# KeyMapping flags
$(TEMP_PATH_Visu)/dis.PS2-Keyboard.vco: $(AS_PROJECT_PATH)/Physical/Config1/X20CP1586/VC/PS2-Keyboard.dis
	$(VCHWPP) -f "$(PANEL_HW_SOURCE_Visu)" -o "$(subst .vco,.vci,$(TEMP_PATH_Visu)/dis.PS2-Keyboard.vco)" -n Visu -d Visu -pal "$(PALFILE_Visu)" -c "$(AS_CONFIGURATION)" -p "$(AS_PLC)" -ptemp "$(AS_TEMP_PLC)" -B "D4.26" -L "" -hw "$(CPUHWC)" -warninglevel 2 -so $(VC_STATIC_OPTIONS_Visu) -sos $(VC_STATIC_OPTIONS_Shared) -keyboard "$(AS_PROJECT_PATH)/Physical/Config1/X20CP1586/VC/PS2-Keyboard.dis" -fp "$(AS_VC_PATH)/Firmware/V4.26.5/SG4" -prj "$(AS_PROJECT_PATH)" -apj "arm" -sfas -vcob "$(VCOBJECT_Visu)"
...
KEYMAP_SOURCES_Visu=$(AS_PROJECT_PATH)/Physical/Config1/X20CP1586/VC/PS2-Keyboard.dis 
...
$(PANEL_HW_VCI_Visu): $(PANEL_HW_SOURCE_Visu) $(VC_LIBRARY_LIST_Visu) $(KEYMAP_SOURCES_Visu)
	$(VCHWPP) -f "$<" -o "$@" -n Visu -d Visu -pal "$(PALFILE_Visu)" -c "$(AS_CONFIGURATION)" -p "$(AS_PLC)" -ptemp "$(AS_TEMP_PLC)" -B "D4.26" -L "" -verbose "False" -profile "False" -hw "$(CPUHWC)" -warninglevel 2 -so $(VC_STATIC_OPTIONS_Visu) -sos $(VC_STATIC_OPTIONS_Shared) -fp "$(AS_VC_PATH)/Firmware/V4.26.5/SG4" -sfas -prj "$(AS_PROJECT_PATH)" -apj "arm" -vcob "$(VCOBJECT_Visu)"

$(PANEL_HW_OBJECT_Visu): $(PANEL_HW_VCI_Visu) $(PALFILE_Visu) $(VC_LIBRARY_LIST_Visu)
	$(VCC) -f "$(subst .vco,.vci,$@)" -o "$@" -cv "$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo" -k "$(VCVK_SOURCES_Visu)" $(VCCFLAGS_Visu) -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4265 -sfas
...
$(TEMP_PATH_Visu)/page.Init_Page.vco: $(AS_PROJECT_PATH)/Logical/Visu/Pages/Init_Page.page $(VC_LANGUAGES_Visu)
	 $(VCC) -f "$<" -o "$@" -l "$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr" -cv "$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo" -pal "$(PALFILE_Visu)" $(VCCFLAGS_Visu) -P "$(AS_PROJECT_PATH)" -ds "$(SRC_PATH_Visu)/StyleSheets/Color.vcs" -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4265 -sfas
...
$(TEMP_PATH_Visu)/vcs.Gray.vco: $(AS_PROJECT_PATH)/Logical/Visu/StyleSheets/Gray.vcs
	 $(VCC) -f "$<" -o "$@" -l "$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr" -cv "$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo" -pal "$(PALFILE_Visu)" $(VCCFLAGS_Visu) -P "$(AS_PROJECT_PATH)" -ds $(DEFAULT_STYLE_SHEET_Visu) -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4265 -sfas
...
$(TEMP_PATH_Visu)/vcvk.VirtualKeys.vco: $(AS_PROJECT_PATH)/Logical/Visu/VirtualKeys.vcvk
	 $(VCC) -f "$<" -o "$@" -l "$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr" -cv "$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo" -pal "$(PALFILE_Visu)" $(VCCFLAGS_Visu)  -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4265 -sfas
...
$(TEMP_PATH_Visu)/tpr.NumPad.vco: $(AS_PROJECT_PATH)/Logical/Visu/TouchPads/NumPad.tpr
	 $(VCC) -f "$<" -o "$@" -l "$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr" -cv "$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo" -pal "$(PALFILE_Visu)" $(VCCFLAGS_Visu) -prj "D:/ASprojects/arm/Logical/Visu" -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4265 -sfas
...
$(VCR_OBJECT_Visu) : $(VCR_SOURCE_Visu)
	$(VCC) -f "$<" -o "$@" -cv "$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo" -sl en $(VCCFLAGS_Visu) -rt  -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4265 -sfas
...
$(TEMP_PATH_Visu)/Visu01.ccf: $(LIB_SHARED) $(SHARED_CCF) $(LIB_BMP_RES_Visu) $(TEMP_PATH_Visu)/Visu03.ccf $(LIB_LOCAL_RES_Visu) $(TEMP_PATH_Visu)/Visu02.ccf $(DIS_OBJECTS_Visu) $(PAGE_OBJECTS_Visu) $(VCS_OBJECTS_Visu) $(VCVK_OBJECTS_Visu) $(VCRT_OBJECTS_Visu) $(TPR_OBJECTS_Visu) $(TXTGRP_OBJECTS_Visu) $(LAYER_OBJECTS_Visu) $(VCR_OBJECT_Visu) $(TDC_OBJECTS_Visu) $(TRD_OBJECTS_Visu) $(TRE_OBJECTS_Visu) $(PRC_OBJECTS_Visu) $(SCR_OBJECTS_Visu)
	...
	$(LINK) "$@.lfl" -o "$@" -p Visu -lib "$(LIB_LOCAL_OBJ_Visu)" -P "$(AS_PROJECT_PATH)" -m "local objects" -profile "False" -warningLevel2 -vcr 4265 -sfas
# 01 Module END
...
$(TEMP_PATH_Visu)/Visu02.ccf: $(LIB_SHARED) $(SHARED_CCF) $(LIB_BMP_RES_Visu) $(TEMP_PATH_Visu)/Visu03.ccf $(BDR_OBJECTS_Visu) $(LFNT_OBJECTS_Visu) $(CLM_OBJECTS_Visu)
	...
	$(LINK) "$@.lfl" -o "$@" -p Visu -lib "$(LIB_LOCAL_RES_Visu)" -P "$(AS_PROJECT_PATH)" -m "local resources" -profile "False" -warningLevel2 -vcr 4265 -sfas
# 02 Module END
...
$(TEMP_PATH_Visu)/Visu03.ccf: $(LIB_SHARED) $(SHARED_CCF) $(BMGRP_OBJECTS_Visu) $(BMINFO_OBJECTS_Visu) $(PALFILE_Visu)
	...
	$(LINK) "$@.lfl" -o "$@" -p Visu -lib "$(LIB_BMP_RES_Visu)" -P "$(AS_PROJECT_PATH)" -m "bitmap resources" -profile "False" -warningLevel2 -vcr 4265 -sfas
# 03 Module END
