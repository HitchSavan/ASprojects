...
PANEL_HW_SOURCE_Visu=D:/ASprojects/kursich/Physical/Config1/Hardware.hw 
DIS_OBJECTS_Visu=$(PANEL_HW_OBJECT_Visu) $(KEYMAP_OBJECTS_Visu)

# KeyMapping flags
$(TEMP_PATH_Visu)/dis.PS2-Keyboard.vco: $(AS_PROJECT_PATH)/Physical/Config1/PC/VC/PS2-Keyboard.dis
	$(VCHWPP) -f "$(PANEL_HW_SOURCE_Visu)" -o "$(subst .vco,.vci,$(TEMP_PATH_Visu)/dis.PS2-Keyboard.vco)" -n Visu -d Visu -pal "$(PALFILE_Visu)" -c "$(AS_CONFIGURATION)" -p "$(AS_PLC)" -ptemp "$(AS_TEMP_PLC)" -B "D4.26" -L "" -hw "$(CPUHWC)" -warninglevel 2 -so $(VC_STATIC_OPTIONS_Visu) -sos $(VC_STATIC_OPTIONS_Shared) -keyboard "$(AS_PROJECT_PATH)/Physical/Config1/PC/VC/PS2-Keyboard.dis" -fp "$(AS_VC_PATH)/Firmware/V4.26.5/SG4" -prj "$(AS_PROJECT_PATH)" -apj "kursich" -sfas -vcob "$(VCOBJECT_Visu)"
...
KEYMAP_SOURCES_Visu=$(AS_PROJECT_PATH)/Physical/Config1/PC/VC/PS2-Keyboard.dis 
...
$(PANEL_HW_VCI_Visu): $(PANEL_HW_SOURCE_Visu) $(VC_LIBRARY_LIST_Visu) $(KEYMAP_SOURCES_Visu)
	$(VCHWPP) -f "$<" -o "$@" -n Visu -d Visu -pal "$(PALFILE_Visu)" -c "$(AS_CONFIGURATION)" -p "$(AS_PLC)" -ptemp "$(AS_TEMP_PLC)" -B "D4.26" -L "" -verbose "False" -profile "False" -hw "$(CPUHWC)" -warninglevel 2 -so $(VC_STATIC_OPTIONS_Visu) -sos $(VC_STATIC_OPTIONS_Shared) -fp "$(AS_VC_PATH)/Firmware/V4.26.5/SG4" -sfas -prj "$(AS_PROJECT_PATH)" -apj "kursich" -vcob "$(VCOBJECT_Visu)"
...
$(TEMP_PATH_Visu)/tpr.NumPad.vco: $(AS_PROJECT_PATH)/Logical/Visu/TouchPads/NumPad.tpr
	 $(VCC) -f "$<" -o "$@" -l "$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr" -cv "$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo" -pal "$(PALFILE_Visu)" $(VCCFLAGS_Visu) -prj "D:/ASprojects/kursich/Logical/Visu" -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4265 -sfas
